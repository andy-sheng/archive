<div class='container'>
	<div class='jumbotron' >
		...
		<div class="panel panel-primary">
			<div class="panel-heading">团体课程<a href="?action=coursemanag" style='color:yellow'>[更多]</a></div>
			<div>
				<table class="table table-hover">
					<thead>
						<tr>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">私教预约<a href="?action=booklookup" style='color:yellow'>[更多]</a></div>
			<div>
				<table class="table table-hover">
					<thead>
						<tr>
