<?php /* Smarty version Smarty-3.1.18, created on 2014-09-22 00:52:26
         compiled from "libs\view\tail.ctp" */ ?>
<?php /*%%SmartyHeaderCode:4372541c6cb80526a8-73835963%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da1258c602a0844604886e0bc99f5938ecdf87fc' => 
    array (
      0 => 'libs\\view\\tail.ctp',
      1 => 1411230385,
      2 => 'file',
  ...
  'nocache_hash' => '4372541c6cb80526a8-73835963',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_541c6cb80ca3d8_20410058',
  'variables' => 
  array (
    'logined' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_541c6cb80ca3d8_20410058')) {function content_541c6cb80ca3d8_20410058($_smarty_tpl) {?>      	</div>
    ...
    <?php if ($_smarty_tpl->tpl_vars['logined']->value['flag']=='false') {?>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <form class="form-signin" role="form" action="index.php?action=login" method="POST" id='login-form'>
            <input type="text" class="form-control" placeholder="邮箱" name='email' id='email' value='<?php echo $_smarty_tpl->tpl_vars['logined']->value['cookie']['email'];?>
' required autofocus >
            <input type="password" class="form-control" placeholder="密码" name='pwd' id='pwd' value='<?php echo $_smarty_tpl->tpl_vars['logined']->value['cookie']['pwd'];?>
'required>
            <label class="checkbox" style='margin-left:20px'>
              <input type="checkbox"  name='remember' id='remember' checked="<?php echo $_smarty_tpl->tpl_vars['logined']->value['cookie']['remember'];?>
"> 记住我
            </label>
