...
<div class="container">
  <div class='jumbotron' style='max-width:700px;margin:auto'>
    <h2>课程信息修改</h2>
    <form role="form" id='form' class='infoModForm' method="POST" action="index.php?action=courseinfomanag">
...
{literal}
  function cancel()
  {
    document.all("form").setAttribute("action", "index.php?action=projmanag&operation=cancel");
    $('#form').submit();  
  }
{/literal}
</script>