...
<div class="panel panel-info">
  ...
  <div class="panel-body">
    ...
    <p>
      <a href='index.php?action=courseinfomanagreq&id={$course.id}'><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-wrench">申请修改信息</span></button></a>

      <a href='#reschedule{$course.id}' data-toggle="modal"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-calendar">申请调课</span></button></a>

      <a href='#deletecourse{$course.id}' data-toggle="modal"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove">申请删除课程</span></button></a>
    </p>
  </div>
  <hr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        <form class="form-signin" role="form" action="index.php?action=coursemanag" method="POST" id='dform'>
          <div class="alert alert-danger">警告：中途结束本课程会返还会员本课程全额款项。</div>  
          <input type="password" class="form-control" placeholder="请输入本账号教练密码" name='pwd' id='pwd' required>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <form class="form-signin" role="form" action="index.php?action=coursemanag" method="POST" id='rform'>
